...
export async function onRequestPost(context) {
  ...
  // Oddiy CORS himoyasi (faqat shu sayt fetch qila oladi, boshqa saytlar emas)
  const corsHeaders = {
  ...
  try {
    ...
    // Xavfsizlik uchun promptni CLIENT'dan emas, SERVERDA o'zimiz yig'amiz —
    // shunda foydalanuvchi promptni o'zgartirib, modelni "boshqa ish qildira olmaydi".
